...
class OrdersApi(object):
    ...
    def delete_order_by_id(self, order_id, **kwargs):  # noqa: E501
        """Метод отмены заказа по ID  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_order_by_id(order_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_order_by_id_with_http_info(order_id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_order_by_id_with_http_info(order_id, **kwargs)  # noqa: E501
            return data

    def delete_order_by_id_with_http_info(self, order_id, **kwargs):  # noqa: E501
        """Метод отмены заказа по ID  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_order_by_id_with_http_info(order_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_order_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('order_id' not in params or
            ...
            raise ValueError("Missing the required parameter `order_id` when calling `delete_order_by_id`")  # noqa: E501
